...
summary = """
This post contains many of the features from the markdown specs supported by Hugo.
It probably doesn't have it all.
Use it to see what everything looks like with this theme.
"""
...
# Markdown & Hugo
[Hugo][hugo] sites can use content formatted as [Markdown][md].
The Markdown specifications it complies with are:
- [Github Flavoured Markdown][github-md]
- [CommonMark Markdown][commonmark-md]

In case this has changed since writing the above, you can [read about it here][hugo-md].
...
[hugo-md]: https://gohugo.io/content-management/formats/#markdown
